        ...
        <>
            ...
            <main className="h-screen overflow-auto bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900">
                ...
                <div className="mt-20 flex flex-col">
                    <p className="text-white text-7xl font-bold text-center">Your new favorite <br></br>Markdown, Note-taking, <br></br>open-source app</p>
                    ...
                    <div>
                        <p className="text-7xl text-white">Hey, it's me</p>
                    </div>
                </div>
            </main>
        </>
